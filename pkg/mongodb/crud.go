...
func UpdateFields(ctx context.Context, collection *mongo.Collection, searchFilter bson.M,
	document any, fields ...string,
) error {
...
func PushItemsToArrayField(ctx context.Context, collection *mongo.Collection, search bson.M,
	arrayFieldName string, items ...interface{},
) error {
	var err error
	if len(items) == 1 {
